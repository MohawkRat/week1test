<html>
    ...
    <head>
        <title>Blind-Questionnaire</title>
    ...
    <body>
        ...
        ?>
        <header>
            <h1>Blind-Questionnaire</h1>
        </header>

        <br></br>

        <img src="https://mi-linux.wlv.ac.uk/~2214257/CarePro/Images/Illnesses_Blind.png" alt="Illnesses_Dementia_Photo" width="150" height="200" class="center">

        <form action= "Questionnaire-Complete.php" method="POST">

            <br></br>
            <p1>Question 1: Is your vision blurry ?</p1>
            ...
            <p1>Question 2: Do you get regular headaches ?</p1>
            ...
            <p1>Question 3: Can you see 100 yards in front of you ?</p1>
            ...
            <p1>Question 4: Do you struggle to read books without squinting ?</p1>
            ...
            <p1>Question 5: Do you have regular tired eyes ?</p1>
