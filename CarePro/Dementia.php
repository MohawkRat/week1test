<html>
    ...
    <head>
        <title>Dementia-Questionnaire</title>
    ...
    <body>
        ...
        ?>
        <header>
            <h1>Dementia-Questionnaire</h1>
        </header>

        <br></br>

        <img src="https://mi-linux.wlv.ac.uk/~2214257/CarePro/Images/Illnesses_Dementia.png" alt="Illnesses_Dementia_Photo" width="150" height="200" class="center">

        <form action= "Questionnaire-Complete.php" method="POST">

            <br></br>
            <p1>Question 1: Is the sky blue ?</p1>
            ...
            <p1>Question 2: Is September the month after August ?</p1>
            ...
            <p1>Question 3: Is the number three an odd number ?</p1>
            ...
            <p1>Question 4: Does summer come after spring ?</p1>
            ...
            <p1>Question 5: Does the postman bring the weekly food shopping ?</p1>
