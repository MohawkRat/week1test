...
<html>
    ...
    <head>
        <title>Deaf-Questionnaire</title>
    ...
    <body>
        ...
        ?>
        <header>
            <h1>Deaf-Questionnaire</h1>
        </header>

        <br></br>

        <img src="https://mi-linux.wlv.ac.uk/~2214257/CarePro/Images/Illnesses_Deaf.png" alt="Illnesses_Dementia_Photo" width="150" height="200" class="center">

        <form action= "Questionnaire-Complete.php" method="POST">

            <br></br>
            <p1>Question 1: Do you hear tinnitus (Ringing in your ears) ?</p1>
            ...
            <p1>Question 2: Do you ask people to speak up in conversations ?</p1>
            ...
            <p1>Question 3: Do people say you are speaking loudly ?</p1>
            ...
            <p1>Question 4: Do you get constant headaches ?</p1>
            ...
            <p1>Question 5: Do you have the tv on loud all of the time ?</p1>
