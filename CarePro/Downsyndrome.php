...
<html>
    ...
    <head>
        <title>Downsyndrome-Questionnaire</title>
    ...
    <body>
        ...
        ?>
        <header>
            <h1>Downsyndrome-Questionnaire</h1>
        </header>

        <br></br>

        <img src="https://mi-linux.wlv.ac.uk/~2214257/CarePro/Images/Illnesses_DownSyndrome.png" alt="Illnesses_Dementia_Photo" width="150" height="200" class="center">

        <form action= "Questionnaire-Complete.php" method="POST">

            <br></br>
            <p1>Question 1: Has anyone in your family got Down syndrome ?</p1>
            ...
            <p1>Question 2: Are you of a limited hieght ?</p1>
            ...
            <p1>Question 3: Do you have small facial features ?</p1>
            ...
            <p1>Question 4: Do you have trouble speaking ?</p1>
            ...
            <p1>Question 5: Do you have a bad emune system ?</p1>
